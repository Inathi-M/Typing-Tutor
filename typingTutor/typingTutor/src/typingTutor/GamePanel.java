...
public class GamePanel extends JPanel implements Runnable {
	    ...
	    private SlidingWord horizontalWord;

		GamePanel(FallingWord[] words, SlidingWord horizontalWord, int maxY,
		   ...
		   //draw the words
		    if (!started.get()) {
		    	...
		    	for (int i=0;i<noWords;i++){	    	
					...
					g.drawString(horizontalWord.getWord(),horizontalWord.getX() + borderWidth,horizontalWord.getY());
					g.setColor(Color.BLACK);
		    	}
			   ...
			   g.drawString("Well done!",width/3 - 80,height/2);
		   } else {
			   g.setFont(new Font("Arial", Font.BOLD, 36));
